...
public class Calculations {
     ...
     *
     * @see gchisto2.utils.Calculations#perc(double, double)
     * @see gchisto2.utils.Calculations#perc(Number, Number)
     */
     ...
     *
     * @see gchisto2.utils.Calculations#perc(double, double)
     * @see gchisto2.utils.Calculations#perc(int, int)
     */
     ...
     * form 100 * (<tt>value</tt> - <tt>base</tt>) / <tt>base</bb>.
     *
     * @see gchisto2.utils.Calculations#percDiff(double, double)
     */
     ...
     * form 100 * (<tt>value</tt> - <tt>base</tt>) / <tt>base</bb>.
     *
     * @see gchisto2.utils.Calculations#percDiff(Number, Number)
     */
