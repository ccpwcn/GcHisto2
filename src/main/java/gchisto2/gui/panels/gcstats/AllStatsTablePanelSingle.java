 ...
 * @author tony
 */
public class AllStatsTablePanelSingle extends GCStatsChartPanel {

    private AllStatsTableSingle panel;
    ...
    private void addTable(DatasetGenerator datasetGenerator,
            Locker locker) {
        panel = new AllStatsTableSingle(datasetGenerator, locker);
     ...
     * or multiple ones.
     */
    public AllStatsTablePanelSingle(
